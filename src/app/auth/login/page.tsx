    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-primary-50 to-white p-4 dark:from-neutral-950 dark:to-neutral-900">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-neutral-500">Sign in to your Deep Check account</p>
        </div>
        ...
        <div className="glass rounded-2xl p-6">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center"><span className="bg-white px-2 text-xs text-neutral-400 dark:bg-neutral-950">or continue with</span></div>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-neutral-500">
            ...
            <a href="/auth/register" className="font-medium text-primary-600 hover:underline">Sign up</a>
          </p>
        </div>
      </div>
    </div>
