          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input disabled value={data?.email || ""} className="min-h-[44px] w-full rounded-xl border border-neutral-200 bg-neutral-50 py-2.5 pl-10 pr-4 text-sm text-neutral-500 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-400" />
              </div>
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input disabled value={data?.phone || ""} className="min-h-[44px] w-full rounded-xl border border-neutral-200 bg-neutral-50 py-2.5 pl-10 pr-4 text-sm text-neutral-500 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-400" />
              </div>
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input disabled value={data?.address || data?.city || ""} className="min-h-[44px] w-full rounded-xl border border-neutral-200 bg-neutral-50 py-2.5 pl-10 pr-4 text-sm text-neutral-500 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-400" />
              </div>
            </div>
          </div>
        )}
      ...
      <div className="glass rounded-2xl p-4 sm:p-5">
        ...
        <div className="mt-4 space-y-3">
          ...
          <div className="flex items-center justify-between rounded-xl border border-neutral-100 p-3 dark:border-neutral-800">
            ...
            <span className="text-sm font-bold text-neutral-900 dark:text-white">{data?.deepReportCredits ?? 0} / 10</span>
          </div>
          <div className="flex items-center justify-between rounded-xl border border-neutral-100 p-3 dark:border-neutral-800">
            <div>
